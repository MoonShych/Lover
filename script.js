...
const CONFIG = {
  ...
  timeline: [
    { date: "01 ต.ค. 2025", title: "วันที่เค้าจีบ", text: "วันที่เค้าจีบจริงๆก็ไม่ได้วันนี้นะเราคบกันมาก่อนน้าาอ้วน แต่เค้าบอก เป็นแฟนกันไหมวันนี้", icon: "💫", image: "" },
    { date: "ร้านหมูกระทะ", title: "อ้วนเลี้ยง🥰", text: "เหมือนจะกินเลี้ยงอ้วนจบ จำได้ว่าเค้าซุกแต่อ้วนตอนเค้าเมา😵‍💫", icon: "🤤", image: "" },
    { date: "ร้านหมูกระทะ", title: "วันที่บอกว่า “รักกัน”", text: "โมเมนต์สำคัญที่ทำให้ทุกอย่างเป็นทางการ เล่าความรู้สึกวันนั้นลงตรงนี้ได้เลย", icon: "❤️", image: "" },
