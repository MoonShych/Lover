...
const CONFIG = {
  ...
  timeline: [
    ...
    { date: "วันอะไรดี", title: "ไอติมอร่อยมะ", text: "เหมือนว่าเป็นเพราะเค้าเลี้ยงไอติมหรือเปล่าน้าา แล้วก็วันต่อมาแต่จำไม่ได้แล้วว่าวันไหน เหมือนมีคนลงสตอรี่ อจ. ว่าให้ทักมาอยากจีบหรือป่าว จำไม่ได้😛", icon: "❤️", image: "" },
