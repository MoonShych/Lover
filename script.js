...
const CONFIG = {
  ...
  timeline: [
    { date: "01 ต.ค. 2025", title: "วันแรกที่เราเจอกัน", text: "จุดเริ่มต้นเล็ก ๆ ที่กลายเป็นเรื่องราวที่สวยที่สุดของฉัน แก้ไขข้อความนี้ให้เป็นเรื่องจริงของคุณสองคนได้เลยนะ 💕", icon: "💫", image: "" },
    { date: "แก้วันที่ตรงนี้", title: "ครั้งแรกที่ได้ออกเดตกัน", text: "ใส่เรื่องราวความทรงจำดี ๆ ของวันนั้นลงไปตรงนี้ได้เลย", icon: "☕", image: "" },
    { date: "แก้วันที่ตรงนี้", title: "วันที่บอกว่า “รักกัน”", text: "โมเมนต์สำคัญที่ทำให้ทุกอย่างเป็นทางการ เล่าความรู้สึกวันนั้นลงตรงนี้ได้เลย", icon: "❤️", image: "" },
    { date: "วันนี้", title: "และเรายังคงรักกันเสมอ", text: "ทุกวันที่ผ่านมาคือความทรงจำที่ฉันอยากเก็บไว้ตลอดไป", icon: "🌸", image: "" }
  ],
...
ขอบคุณที่เดินเข้ามาในชีวิตของฉัน และทำให้ทุกวันธรรมดา
กลายเป็นวันที่พิเศษ ขอบคุณสำหรับรอยยิ้ม กำลังใจ
และความรักที่เธอมอบให้เสมอมา

ไม่ว่าจะอีกกี่วัน กี่เดือน หรือกี่ปี ฉันก็ยังอยากให้เธอ
เป็นคนที่เดินเคียงข้างฉันไปตลอด
