...
const CONFIG = {
  ...
  timeline: [
    ...
    { date: "วันอะไรดี", title: "ไอติมรักมะ", text: "เหมือนว่าเป็นเพราะเค้าเลี้ยงไอติมหรือเปล่าน้าา แล้วก็วันต่อมาจำไม่ได้แล้วว่าอีกวัน แต่เหมือนมีคนลงสตอรี่ อจ. ว่าให้ทักมาอยากจีบหรือป่าว จำไม่ได้😛", icon: "❤️", image: "" },
